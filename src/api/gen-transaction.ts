...
export function transactionHash(payload: Uint8Array, si: SignatureInfo): Buffer {
...
export function txDataToSign(payload: Uint8Array, si: SignatureInfo): Buffer {
  return Buffer.concat([uvarintMarshalBinary(si.nonce), transactionHash(payload, si)]);
}
