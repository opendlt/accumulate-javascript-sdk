...
export async function signTransaction(transaction: Transaction, signer: PageSigner, opts: { timestamp?: number } = {}): Promise<Envelope> {
...
async function doSign(transaction: Transaction, signer: PageSigner, timestamp?: number): Promise<KeySignature> {
